...
export default function AuthButton() {
  ...
  if (isAuthenticated) {
    return (
      <div className="flex items-center gap-1.5" title={authUsername || ''}>
        {authAvatarUrl ? (
          <img
            src={authAvatarUrl}
            alt=""
          ...
          <span className="w-5 h-5 rounded-full bg-zinc-700 flex items-center justify-center text-[10px] text-zinc-400">
